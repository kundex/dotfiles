...
auswahl=$(cat ~/.config/qutebrowser/quickmarks | dmenu -bw 2 -l 40 -g 6 -nb '#2f343f' -nf '#fff7bc' -sb '#83af9b' -nhf '#000000' -nhb '#ff5555' -shb '#0a81f5' -shf '#ffffff' -p 'lesezeichen:' -fn 'DejaVuSansBold:pixelsize=12')
